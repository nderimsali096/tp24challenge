...
namespace TP24.UnitTests.Utilities
{
    ...
    {
        public ReceivablePayload GenerateValidReceivablePayload()
        {
        ...
        public ReceivablePayload GenerateInvalidReceivablePayload()
        {
            return new ReceivablePayload
            {
                IssueDate = "2023-08-01",
        ...
        public List<ReceivablePayload> GenerateListOfReceivablePayloads()
        {
